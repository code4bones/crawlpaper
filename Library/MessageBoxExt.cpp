...
//     - The MessageBoxExt dialog will now be centered even in non-MFC apps,
...
protected:
	...
	{
		//ButtonWidth         = 82,
		ButtonWidth         = 80, //LPI 90,
		ButtonTimeoutWidth  = 90, //LPI 100,
		ButtonHeight        = 25, //LPI 26,
		ButtonSpacing       = 3, //LPI 6,
		BottomMargin        = 10, //LPI 12,
		DoNotAskAgainHeight = 14, //LPI 16,
		...
		SpacingSize         = 8,
		MessageSize         = 64*1024,
		SpacingBetweenMessageAndButtons = 8, //LPI 10,
	};
...
// MessageBoxExt()
//
// The MessageBoxExt function creates, displays, and operates a message box.
...
//     http://www.codeproject.com/dialog/xmessagebox.asp
//
// int MessageBoxExt(HWND hwnd,                 // handle of owner window
...
//                         struct XMSGBOXPARAMS is defined in MessageBoxExt.h.
//
///////////////////////////////////////////////////////////////////////////////

int MessageBoxExt(HWND hwnd,
				LPCTSTR lpszMessage,
				...
				XMSGBOXPARAMS * pXMB /*= NULL*/)
{
		...
		(nStyle & MB_DONOTSHOWAGAIN))
	{
		...
		if (xmb.lpszModule && (xmb.lpszModule[0] != _T('\0')))
		{
			...
			// data string is hex value of MessageBoxExt return code
...
void CXDialogTemplate::LoadButtonStrings()
{
	...
	_tcscpy(szDoNotShowAgain, _T("Don't show me again"));
