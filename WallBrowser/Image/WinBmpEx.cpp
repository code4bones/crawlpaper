...
/--------------------------------------------------------------------
|
|      $Id: WinBmpEx.cpp,v 1.4 2000/09/01 13:27:06 Administrator Exp $
...
#include "window.h"
#include "l:\wallpaper\image\include\WinBmpEx.h"
#include "l:\paintlib\include\paintlib.h"
...
//
BOOL CWinBmpEx::DrawEx( HDC dc, const RECT* rcDst, const RECT* rcSrc,
...
// Draw DIB on DC.
void CWinBmpEx::Draw( HDC dc, int x, int y, DWORD )
{
...
BOOL CWinBmpEx::DrawExtract( HDC dc, POINT pntDest, RECT rcSrc )
{
    // Compute destination rectangle
    RECT rcDst;
...
void CWinBmpEx::StretchDraw( HDC dc, int x, int y, double Factor, DWORD )
{
    // Compute rectangles
    RECT rcSrc, rcDst;
    rcSrc.left	    = 0;
...
void CWinBmpEx::StretchDraw( HDC hDC, int x, int y, int w, int h, DWORD )
{
    // Compute rectangles
    RECT rcSrc, rcDst;
    rcSrc.left	    = 0;
...
//
HPALETTE CWinBmpEx::CreatePalette(void)
{
...
void CWinBmpEx::BuildLogPalette(void)
{
    if (m_pal)
    {
        ::DeleteObject(m_pal);
...
HPALETTE CWinBmpEx::GetLogPalette(void)
{
