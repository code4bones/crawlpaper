...
//*************************************************************************
#include "window.h"        // Standard windows header file
#include <afxpriv.h>       //SK: makes A2W and other spiffy AFX macros work
#include "BCMenu.h"        // BCMenu class declaration

#ifdef _BCMENU_USE_CARTOONS_MENU
...
#if _MFC_VER < 0x400
  #error MFC 4.0 required (at least)
#endif
...
// LPI (checked only on W2k) If the app sets the transparency value for the main window and the menu have XP style set, the checked items are not redrawed correctly (no check mark appears). For a smart fix simply always call the DrawCheckMark() member with the narrowflag parameter set to FALSE.
...
#endif // _BCMENU_USE_CARTOONS_MENU
